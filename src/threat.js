...
//
// mode is 'idle' | 'chase' | 'search' (6.11) | 'shed' (6.12) — 'search' is the
// yeti hunting your last-known spot after losing sight (tension holds, strings
// ease off); 'shed' is him breaking off to go check a hut, audio-wise treated
// like idle-with-proximity.
//
